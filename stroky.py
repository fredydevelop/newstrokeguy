...
def multi_prediction(uploaded_file):
    ...
    for column in dfinput.columns:
        ...
        # Remove stroke, ID and index columns
        if column in [
            "stroke",
            "id",
            "index"
        ...
        # Remove index columns automatically
        # created when Pandas saves a CSV
